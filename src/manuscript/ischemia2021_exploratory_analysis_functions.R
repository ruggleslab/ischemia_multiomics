...
# set_cibersort_binary("../../code/immunedeconv_scripts/cibersort_files/CIBERSORT_MGC_CUSTOM.R")
# set_cibersort_mat("../../code/immunedeconv_scripts/cibersort_files/LM22.txt")
